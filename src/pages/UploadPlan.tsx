            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <Textarea id="desc" value={description} onChange={e => setDescription(e.target.value)} placeholder="Describe the plan, layout, and unique features..." rows={4} maxLength={2000} />
                </div>
              ...
              <CardContent>
                <div className="grid gap-4 grid-cols-2 sm:grid-cols-4">
                  <div className="space-y-2">
                    ...
                    <Input type="number" value={bedrooms} onChange={e => setBedrooms(Number(e.target.value))} min={1} max={20} />
                  </div>
                  <div className="space-y-2">
              ...
              <CardContent className="space-y-3">
                <div className="flex gap-2">
                  <Input
                    ...
                    placeholder="e.g. Open-plan kitchen"
                    maxLength={100}
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-xs text-muted-foreground">The complete plan file buyers will receive. Max 20MB. Stored securely.</p>
                  {pdfFile ? (
